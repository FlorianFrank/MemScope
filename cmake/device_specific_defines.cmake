if (BUILD_FOR_STM32)
    ...
    if (BUILD_FOR_STM32F429)
        set(CMAKE_TOOLCHAIN_FILE "${DEP_ROOT_DIR}/cmake/toolchains/toolchain_stm32f429.cmake")
    ...
    set_property(SOURCE ${DEP_ROOT_DIR}/startup/startup_${BoardType}xx.s PROPERTY LANGUAGE C)
